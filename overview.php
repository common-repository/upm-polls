<?php
	...
	if( $_POST[ 'pppm_hidden' ] == 'x' ) {
		...
		update_option('pppm_poll_dtype', $_POST['pppm_poll_dtype']);
		#################################################################################
	}
...
.upm_no{
 ...
 <?php echo '<script src="'.PPPM_1_PATH .'js/jquery-1.4.2.min.js"> </script>'; ?>
				<script type="text/javascript" src="<?php echo PPPM_1_PATH ?>js/jMask.js" ></script>
                <script type="text/javascript" src="<?php echo PPPM_1_PATH ?>js/cufon-yui.js" ></script>
                <script type="text/javascript" src="<?php echo PPPM_1_PATH ?>js/GeosansLight_500.font.js"  ></script>
                <script type="text/javascript" src="<?php echo PPPM_1_PATH ?>js/raphael-min.js"  ></script>
                <script type="text/javascript" src="<?php echo PPPM_1_PATH ?>js/custom.js"  ></script>
                <link rel="stylesheet" href="<?php echo PPPM_1_PATH ?>css/style.css" type="text/css"  />
                <link rel="stylesheet" href="<?php echo PPPM_1_PATH ?>css/jMask.css" type="text/css"  />
	...
	<form name="form_options" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <table width="100%" border="0">
          <tr>
            <td style="padding:10px; padding-left:0px; vertical-align:top; width:500px;">
                ...
                <thead>
                <tr>
                <th>&nbsp;That's happened! Convert any CMS or Forum to Wordpress</th>
                </tr>
                </thead>
                <tr>
                <td style="width:500px;">
                  
                    <div id="home_left_box2" style="margin:0px auto; width:450px;">
                        <div id="innerblock">
                        <div id="gconverter">
                        <div>
                        <ul>
                        <li><a href="http://gconverter.com/joomla-to-wordpress/"><img src="<?php echo PPPM_1_PATH ?>img/gc/5.png" /></a>
                        <p>
                        <a href="http://gconverter.com/">
                        <span style="font-size:14px; font-weight:bold; font-family:Georgia, 'Times New Roman', Times, serif;">gConverter.com</span>
                        </a>
                        <br />
                        <span style="font-size:13px">We are removing boundaries between Content Management Systems.</span>
                        </p>
                        </li>
                        <li><a href="http://gconverter.com/joomla-to-wordpress/"><img src="<?php echo PPPM_1_PATH ?>img/gc/3.png" /></a>
                        <p>
                        <a href="http://gconverter.com/joomla-to-wordpress/">
                        <span style="font-size:14px; font-weight:bold; font-family:Georgia, 'Times New Roman', Times, serif;">CMS to CMS</span>
                        </a>
                        <br />
                        <span style="font-size:13px">We are converting 12 different Content Management Systems.</span>
                        </p>
                        </li>
                        <li><a href="http://gconverter.com/vbulletin-to-wordpress/"><img src="<?php echo PPPM_1_PATH ?>img/gc/2.png" /></a>
                        <p>
                        <a href="http://gconverter.com/vbulletin-to-wordpress/">
                        <span style="font-size:14px; font-weight:bold; font-family:Georgia, 'Times New Roman', Times, serif;">Forum to CMS</span>
                        </a>
                        <br />
                        <span style="font-size:13px">We are converting 12 different Discussion Boards/Forums</span>
                        </p>
                        </li>
                        <li><a href="http://gconverter.com/start/"><img src="<?php echo PPPM_1_PATH ?>img/gc/4.png" /></a>
                        <p>
                         <a href="http://gconverter.com/start/"><span style="font-size:14px; font-weight:bold; font-family:Georgia, 'Times New Roman', Times, serif;">gConverter.com</span></a>
                         <br />
                         <span style="font-size:13px">Just 4 steps to get things done.</span> 
                        </p>
                        </li>
                        <li><a href="http://gconverter.com/"><img src="<?php echo PPPM_1_PATH ?>img/gc/1.png" /></a>
                        <p>
                           <a href="http://gconverter.com/"><span style="font-size:14px; font-weight:bold; font-family:Georgia, 'Times New Roman', Times, serif;">gConverter.com</span></a>
                           <br />
                           <span style="font-size:13px"> vBulletin to Wordpress, phpBB to Wordpress, Joomla to Wordpress, Drupal to Wordpress and another 24 Forums and CMS.</span> 
                        </p>
                        </li>
                        </ul>
                        </div>
                ...
                <!--
                    <tr valign="top">
                        <td style="background:#FFF; text-align:center; font-size:12px;">
                        <img src="<?php echo PPPM_1_PATH .'img/' ?>gconverter.png" />
                        </td>
                    </tr>
                    <tr valign="top">
                        <td style="background:#FFF; text-align:center; font-size:12px;">
                        vBulletin to Wordpress, phpBB to Wordpress, Joomla to Wordpress, Drupal to Wordpress and another 24 Forums and CMS.
                        </td>
                    </tr>
                -->
                </table>
            ...
            <table width="100%" border="0" cellspacing="1" class="widefat">
                ...
                <th>&nbsp;Information</th>
                    ...
                    <tr valign="top">
                        ...
                        Please DO NOT use <a href="http://wordpress.org/extend/plugins/universal-post-manager/">Universal Post Manager</a> and UPM Polls plugins together , one of them should be deactivated !
                        </td>
                    </tr>
                </table><br />
        ...
        <thead>
        	...
        	<tr valign="top">
				<th class="pppm_option_th">
				<?php _e( 'Poll Display Type' ) ?>
				</th>
				<td class="pppm_option_td">
				&nbsp;&nbsp;<input type="radio" id="pppm_poll_dtype_1" name="pppm_poll_dtype" value="1" 
				<?php echo $pppm_checked['radio'][ 'pppm_poll_dtype' ][ 'on_check' ] ?>/> 
				<label for="pppm_poll_dtype_1"><?php _e( 'Only poll answers' ) ?></label> &nbsp;&nbsp; 
				<input type="radio" id="pppm_poll_dtype_0" name="pppm_poll_dtype" value="0" 
				<?php echo $pppm_checked['radio'][ 'pppm_poll_dtype' ][ 'off_check' ] ?> />
				<label for="pppm_poll_dtype_0"><?php _e( 'Poll answers with current results' ) ?></label>
