				...
				<table width="100%" class="pppm_box_table" border="0" cellspacing="1">
                  ...
                  <tr>
                      ...
                      <div style="position:absolute;color:#DD0000; width:100%; top:7px; font-weight:bold; text-align:right;"><span style="cursor:pointer;" onclick="UPM_Logs('close')" title="close">x</span> &nbsp;</div>
                  	  <iframe src="<?php echo PPPM_1_PATH ?>js/blank.html" name="upm_logs" id="upm_logs" frameborder="0" style="width:100%; height:500px;margin:0px; border:0px; overflow:hidden; outline:0px;" scrolling="no"></iframe>
                      </div>
                      </td>
                  </tr>
                  <!-- Post Specific Polls -->
                  ...
                  <tr>
                      ...
                      <div style="position:absolute;color:#DD0000; width:100%; top:7px; font-weight:bold; text-align:right;"><span style="cursor:pointer;" onclick="UPM_sLogs('close')" title="close">x</span> &nbsp;</div>
                  	  <iframe src="<?php echo PPPM_1_PATH ?>js/blank.html" name="upm_slogs" id="upm_slogs" frameborder="0" style="width:100%; height:500px;margin:0px; border:0px; overflow:hidden; outline:0px;" scrolling="no"></iframe>
                      </div>
                      </td>
                  </tr>
				</table>
