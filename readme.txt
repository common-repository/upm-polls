...
Best Plugin to create Polls for your site. Everything is smoother, faster, and seamless like Wordpress itself.
  ...
  * Poll Manager,
	...
	* Ability to show polls either with and without current results of polls

== Installation ==

  * Extract "upm-polls.1.0.4.zip" archive.
...
1. UPM Polls Widget with Results
2. UPM Polls Widget without Results
3. UPM Polls General Settings
4. UPM Polls Manager - Logs
5. UPM Polls Manager - Add/Edit & Templates
...
= 1.0.3 =
* Fixed Bug : No result after vote, Total Voters:0
* Fixed Bug : Blank area after vote
* Added : More Secure Voting
* Added : Ability to show polls either with or without current results of polls

= 1.0.4 =
* Fixed Bug : Warning: Division by zero in.....
* Fixed Bug : Security issues
* Fixed Bug : Other bugs 
* Added : Compatibility with Wordpress 3.2.x versions
* Added : Everything is smoother, faster, and seamless